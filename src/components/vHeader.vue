          ...
          <div class="mobile-menu ">
              ...
              <div class="container">
                <div class="row">
                  <div class="menu-info d-flex justify-content-between align-items-center">
                    <div class="menubar"> <span></span> <span></span> <span></span> </div> <a href="/" class="logo"> <img
                        src="src/assets/images/logo/logo.png" alt=""> </a>
            ...
            <div class="mobile-menu__sidebar-menu">
              ...
              <ul class="page-dropdown-menu">
                <li class="dropdown-list"> <a href="/"> <span>Home</span> </a>
                </li>
                <li class="dropdown-list"> <a href="/products"> <span>Shop </span>
                  </a>
                </li>
                ...
                <div class="col-12">
                  <div class="some-info">
                    <p class="d-flex align-items-center"> <span class="icon"> <i class="flaticon-power"></i> </span>
                      Welcome to ZheKarte Online Shop</p>
                    ...
                    <div class=" d-flex align-items-center justify-content-between ">
                      <nav>
                        <ul class="page-dropdown-menu d-flex align-items-center justify-content-center">
                          ...
                          <li class="dropdown-list"> <router-link :to="{ name: 'product.index' }"> <span>Shop </span>
                            </router-link>
                          </li>
                          <li class="dropdown-list"> <router-link :to="{ name: 'about' }">О нас</router-link> </li>
                        </ul>
                      </nav>
      ...
      <div class="mobile-menu d-lg-none d-block">
        <div class="mobile-menu__menu-top border-bottom-0">
          <div class="container">
            <div class="row">
              <div class="menu-info d-flex justify-content-between align-items-center">
                <div class="menubar"> <span></span> <span></span> <span></span> </div> <a href="/" class="logo">
